...
Architecture and product documentation for the Hospital Management SaaS platform.
...
| [PROJECT_STRUCTURE.md](PROJECT_STRUCTURE.md) | **Frozen** folder structure |
| [FOLDER_STRUCTURE_FREEZE.md](FOLDER_STRUCTURE_FREEZE.md) | Structure enforcement rules |
| [DATABASE_DESIGN.md](DATABASE_DESIGN.md) | PostgreSQL schema design |
